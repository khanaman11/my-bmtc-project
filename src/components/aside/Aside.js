    ...
    return (
        <div className="col-4 aside-bg">
            ...
            <div className='aside-tag-wrapper'>
                <div className={`aside-tag-cnt ${activeItemIndex===0 ? "active":""}`}>
                    <div className='icon-box'>
                        <span><img src={maskGroup} alt="user-icon" /></span>
                    </div>
                    <div>
                ...
                <div className={`aside-tag-cnt ${activeItemIndex===1 ? "active":""}`}>
                ...
                <div className={`aside-tag-cnt ${activeItemIndex===2 ? "active":""}`}>
                ...
                <div className={`aside-tag-cnt ${activeItemIndex===3 ? "active":""}`}>
                ...
                <div className={`aside-tag-cnt ${activeItemIndex===4 ? "active":""}`}>
